...
class Navbar extends Component {
    render() {
        return (
            <div className="nav-cover" style={{ backgroundImage: 'url(' + farrellHall + ')' }}>
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul className="navbar-nav navList">
                            <li className="nav-item">
                                <Link to='/' className="nav-link hvr-underline-from-center active">Home <span className="sr-only">(current)</span></Link>
                            </li>
                            <li className="nav-item">
                ...
                <div className="homeImgQuote">
                    <h4><q><b>Don't be afraid to give up the good to go for the great.</b></q><br></br> -- John D. Rockefeller</h4>
                </div>
            </div>
        );
    }
